              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <Field
                      ...
                      className={classNames(
                        values.podNumber === ""
                          ? "text-gray-400"
                          : "text-gray-900",
                        "block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-lime-600 sm:text-sm sm:leading-6"
                      )}
                    >
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      disabled
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lime-600 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 sm:text-sm sm:leading-6"
                      value={(function () {
              ...
              <button
                ...
                className={classNames(
                  isSubmitting
                    ...
                    : "bg-lime-600 hover:bg-lime-500 focus-visible:outline-lime-600 cursor-pointer",
